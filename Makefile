...
GO_TEST_PACKAGES ?= $(filter-out $(shell $(GO) list forgente.com/modelmigration/...) forgente.com/tests/integration/migration-test forgente.com/tests forgente.com/tests/integration,$(shell $(GO) list ./... | grep -v /vendor/))
MIGRATE_TEST_PACKAGES ?= $(shell $(GO) list forgente.com/modelmigration/...)
...
.PHONY: migrations.individual.test\#%
migrations.individual.test\#%:
	$(GO) test $(GOTEST_FLAGS) -tags '$(TAGS)' forgente.com/modelmigration/$*
