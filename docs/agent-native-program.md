...
the harder half — `AN-IDENT-2`, sessions themselves, the egress restriction
below, and the no-self-approve rules.
...
What remains in this layer is sessions themselves and the no-self-approve
rules.
