...
func newDumpCommand() *cli.Command {
	return &cli.Command{
		Name:        "dump",
		Usage:       "Dump Forgente files and database",
		Description: `Dump compresses all related files and database into zip file. It can be used for backup and capture Forgente server image to send to maintainer`,
		Action:      runDump,
		Flags: []cli.Flag{
			&cli.StringFlag{
				Name:    "file",
