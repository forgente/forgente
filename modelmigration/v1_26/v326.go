...
func loadLegacyMigrationRunGroups(x base.EngineMigration) (map[int64]map[string]*commitSHAAndRuns, error) {
...
func getRepoLinkCached(x base.EngineMigration, cache map[int64]string, repoID int64) (string, error) {
...
func getJobIDByIndexCached(x base.EngineMigration, cache map[int64][]int64, runID, jobIndex int64) (int64, bool, error) {
