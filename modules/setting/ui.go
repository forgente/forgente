...
var UI = struct {
	...
	Meta: struct {
		...
		Author:      "Forgente - A painless self-hosted Git service",
		Description: "Forgente is a painless self-hosted Git service written in Go",
		Keywords:    "go,git,self-hosted,forgente",
	},
}
