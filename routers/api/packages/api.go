...
import (
	...
	"forgente.com/routers/api/packages/alpine"
	"forgente.com/routers/api/packages/arch"
	"forgente.com/routers/api/packages/cargo"
	"forgente.com/routers/api/packages/chef"
	"forgente.com/routers/api/packages/composer"
	"forgente.com/routers/api/packages/conan"
	"forgente.com/routers/api/packages/conda"
	"forgente.com/routers/api/packages/container"
	"forgente.com/routers/api/packages/cran"
	"forgente.com/routers/api/packages/debian"
	"forgente.com/routers/api/packages/generic"
	"forgente.com/routers/api/packages/goproxy"
	"forgente.com/routers/api/packages/helm"
	"forgente.com/routers/api/packages/maven"
	"forgente.com/routers/api/packages/npm"
	"forgente.com/routers/api/packages/nuget"
	"forgente.com/routers/api/packages/pub"
	"forgente.com/routers/api/packages/pypi"
	"forgente.com/routers/api/packages/rpm"
	"forgente.com/routers/api/packages/rubygems"
	"forgente.com/routers/api/packages/swift"
	"forgente.com/routers/api/packages/terraform"
	"forgente.com/routers/api/packages/vagrant"
