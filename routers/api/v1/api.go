...
// Package v1 Forgente API
//
// This documentation describes the Forgente API.
//
//	Schemes: https, http
...
import (
	...
	"forgente.com/routers/api/v1/activitypub"
	"forgente.com/routers/api/v1/admin"
	"forgente.com/routers/api/v1/misc"
	"forgente.com/routers/api/v1/notify"
	"forgente.com/routers/api/v1/org"
	"forgente.com/routers/api/v1/packages"
	"forgente.com/routers/api/v1/repo"
	"forgente.com/routers/api/v1/settings"
	"forgente.com/routers/api/v1/token"
	...
	_ "forgente.com/routers/api/v1/swagger" // for swagger generation
