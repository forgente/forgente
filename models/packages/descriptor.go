...
import (
	...
	"forgente.com/modules/packages/alpine"
	"forgente.com/modules/packages/arch"
	"forgente.com/modules/packages/cargo"
	"forgente.com/modules/packages/chef"
	"forgente.com/modules/packages/composer"
	"forgente.com/modules/packages/conan"
	"forgente.com/modules/packages/conda"
	"forgente.com/modules/packages/container"
	"forgente.com/modules/packages/cran"
	"forgente.com/modules/packages/debian"
	"forgente.com/modules/packages/helm"
	"forgente.com/modules/packages/maven"
	"forgente.com/modules/packages/npm"
	"forgente.com/modules/packages/nuget"
	"forgente.com/modules/packages/pub"
	"forgente.com/modules/packages/pypi"
	"forgente.com/modules/packages/rpm"
	"forgente.com/modules/packages/rubygems"
	"forgente.com/modules/packages/swift"
	"forgente.com/modules/packages/vagrant"
